...
elo_df['home_team_prob'] = np.where(is_home, elo_df['elo_prob1'], elo_df['elo_prob2'])
elo_df['away_team_prob'] = np.where(is_home, elo_df['elo_prob2'], elo_df['elo_prob1'])
...
elo_df.to_csv('mlb.csv', index=False)
...
features = ['home_team_elo', 'away_team_elo', 'rest_days_home', 'rest_days_away',
            ...
            'away_recent_win_rate','home_avg_goals_scored','home_avg_goals_conceded','away_avg_goals_scored','away_avg_goals_conceded',
